...
TOKEN_LENGTHS = {
    ...
    "csrf": CSRF_TOKEN_LENGTH
}

QUERY_MAX_LENGTH = 100
QUERY_MAX_RESULTS = 50
QUERY_RANDOMIZE_USERS = True
...
INPUT_LENGTH_LIMITS = {
    ...
    "recovery": (0, ACCOUNT_RECOVERY_TOKEN_LENGTH),
